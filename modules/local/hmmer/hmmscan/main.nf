process HMMER_HMMSCAN {
    ...
    input:
    tuple val(meta), val(hmmdb), path(seqfile), val(write_align), val(write_target), val(write_domain), val(write_pfam)
    ...
    ${write_pfam ? "touch ${prefix}.pfamtbl" : ''}
